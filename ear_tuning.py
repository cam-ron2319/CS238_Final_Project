...
from OG_transititions import run_simulation
...
class POMDP:
    def __init__(self):
        ...
        Args:
            intervals: List of musical intervals to assess
            beta_distributions: Dict mapping interval and skill level to (alpha, beta) parameters
        """
    ...
    def update(self, belief, P, action, observation):
        ...
        :param P: POMDP instance
        :param action: Action taken (interval as a string)
    ...
    def random_action(self, P):
        return np.random.choice(P.actions)
